<div class="tickets index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('expected_duration'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($ticket['Ticket']['short_description']); ?>&nbsp;</td>
		<td><?php echo h($ticket['Ticket']['color']); ?>&nbsp;</td>
		<td><?php echo h($ticket['Ticket']['comment']); ?>&nbsp;</td>
		<td><?php echo h($ticket['Ticket']['expected_duration']); ?>&nbsp;</td>
		<td><?php echo h($ticket['Ticket']['opened']); ?>&nbsp;</td>
		<td><?php echo h($ticket['Ticket']['state_id']); ?>&nbsp;</td>
